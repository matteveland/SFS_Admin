...
<body class="hold-transition login-page">
  <div class="login-box">
    ...
    <div class="card card-outline card-primary">
      ...
      <div class="card-body">
        <p class="login-box-msg">Welcome to SFS Aministration Set-up. This page is designed to assist in setting up your unit for use with SFSAdmin.com.  </p>

        <form action="2-set-up-section-name.php" method="post">
