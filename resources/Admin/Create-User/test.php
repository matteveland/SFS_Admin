...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
      ...
      <?php
        echo __DIR__;
        include "../../../resources/Navigation/NavBar.php"; ?>
    <!--side bar-->
      <?php include "../../../resources/Navigation/sidebar.php"; ?>
        ...
        <div class="content-wrapper" style="min-height: 1403.625px;">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Insert Vehcile Data</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="card card-primary">
                                        ...
                                        <!-- /.card-header -->
                                        <!-- form start -->
                                        <form action="insert-vehicle-report.php" method="post">
                                            <div class="card-body">
                                            ...
                                            <?php include('/Admin/sectionSelect.php');?>
                                                ...
                                                <div class="form-group" id="dim_reportMissing1800">
                                                    <label for="reportMissing1800" style="text-align: left">Reported to VCO</label><br>
                                                ...
                                                <div class="form-group" id="dim_reportMissingWaiverCard">
                                                    <label for="reportMissingWaiverCard" style="text-align: left">Reported to VCO</label><br>
                                              ...
                                              <input type="text" name="inputWaiverCardNotes" id="inputWaiverCardNotes" class="form-control"
                                                     value="" placeholder="">
                                          </div>
            ...
            <!-- jQuery -->
            <script src="/Users/matteveland/Code/sfsadmin/AdminLTE-master/plugins/jquery/jquery.min.js"></script>
            <!-- Bootstrap 4 -->
            <script src="/Users/matteveland/Code/sfsadmin//AdminLTE-master/plugins/bootstrap/js/bootstrap.bundle.min.js"></script>
            <!-- AdminLTE App -->
            <script src="/Users/matteveland/Code/sfsadmin/AdminLTE-master/dist/js/adminlte.min.js"></script>
