...
permissionsToEdit('Fitness', $findUser->lastName, $findUser->dodId, $findUser->unitName, '/resources/operations/section-view-roster.php');
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Section Fitness Qualifications
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <?php include "section-find-fitness.php";?>
                            </div>
                            <!-- /.card-body -->
                        </div>
                        <!-- /.card -->
