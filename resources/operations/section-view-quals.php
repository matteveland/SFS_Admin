                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Section Weapons Qualifications
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <?php include "section-find-quals.php";?>
                            </div>
                            <!-- /.card-body -->
                        </div>
                        <!-- /.card -->
...
function openWindow() {
  window.open("section-insert-new-duty-qual.php");
}
