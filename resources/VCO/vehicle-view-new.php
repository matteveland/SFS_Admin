...
permissionsToEdit('VCO', $findUser->lastName, $findUser->dodId, $findUser->unitName, '/resources/VCO/vehicle-report.php');
                  ...
                  <div class="col-md-10">
                    ...
                    <div class="card card-primary">
                      <div class="card-header">
                        <h3 class="card-title">Add vehicle into <?php echo $findUser->unitName;?> inventory</h3>
                      </div>
                      <!-- /.card-header -->
                      <!-- form start -->
                        ...
                        <div class="card-body">
                          ...
                          <div class="form-group">
                            ...
                            <select class="form-control" id="multiSelectEquipmentInstalled" name="multiSelectEquipmentInstalled[]" multiple="multiple" required size="10">
                              ...
                              $vehEquipment = $mysqli->query("SELECT equipmentType FROM `vehicleEquipment` WHERE unitName = '$findUser->unitName'");
                              $vehEquipmentArray = $vehEquipment->fetch_assoc();
                              $vehEquipmentArray = explode(',', $vehEquipmentArray['equipmentType']);

                              if ($vehEquipmentArray == NULL) {
                                echo '<option value="">Your unit has no equipment loaded. Contact System Administrator.</option>';
                              }else {
                                foreach ($vehEquipmentArray as $key => $value){
