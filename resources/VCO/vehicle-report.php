...
//$findUser->unitName is used to find unit name.
                      ...
                      <div class="card-body">
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-control" id="selectVehicle" name="selectVehicle" title="selectVehicle" autofocus required>
                            ...
                            <?php
                            $recallStandardVehicleInformation = $mysqli->query("SELECT registration FROM vehicles_daily WHERE unitName = '$findUser->unitName' AND registration NOT LIKE '%DELETE_%' ORDER BY registration ASC");
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-control" title="location" id="location" name="location" autofocus required>
                            ...
                            //find post for unit
                            // $findPost = "SELECT `post/patrol` from post where unitName = '$findUser->unitName'";
                            $findPost = $mysqli->query("SELECT `post/patrol` from post where unitName = '$findUser->unitName'") or die(mysqli_errno($mysqli));
