    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Alarm Data Tables</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="<?php echo $home_link; ?>">Home</a></li>
                <li class="breadcrumb-item active">Alarm Data Tables</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-lg-12">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                  <?php include "find-alarm-data-interior.php";?>
                </div>
...
$(function () {
  ...
  $('#ExteriorAlarmTables').DataTable({
    ...
    "autoWidth": false,
    "responsive": true,
  }).buttons().container().appendTo('#ExteriorAlarmTables_wrapper .col-md-6:eq(0)');
  $('#InteriorAlarmTables').DataTable({
    ...
    "autoWidth": false,
    "responsive": true,
  }).buttons().container().appendTo('#InteriorAlarmTables_wrapper .col-md-6:eq(0)');
  $('#AdminViewCompletedAlarmTables').DataTable({
    ...
    "autoWidth": false,
    "responsive": true,
  }).buttons().container().appendTo('#AdminViewCompletedAlarmTables_wrapper .col-md-6:eq(0)');
});
</script>
</body>
